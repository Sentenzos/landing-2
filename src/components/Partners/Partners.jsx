      ...
      <section className="partners">
        <div className="partners__content">
          ...
          <div className="partners-firms-wrapper">
            <div className="partners-firms__left-btn" ref={leftArrow} onMouseDown={scrollToLeft}  onTouchStart={scrollToLeft}/>
            ...
            <div className="partners-firms__right-btn" ref={rightArrow} onMouseDown={scrollToRight}  onTouchStart={scrollToRight}/>
          </div>
        </div>
      </section>
    </ScrollableAnchor>
